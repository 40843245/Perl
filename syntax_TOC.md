...
- [Perl](#perl)
   * [syntax](#syntax)
      + [overview of data type](#overview-of-data-type)
      ...
      + [data type](#data-type)
         - [string](#string-1)
            * [concatenation of two strings](#concatenation-of-two-strings)
            * [repetive of a string](#repetive-of-a-string)
            * [embeding a variable in string](#embeding-a-variable-in-string)
            * [get length of string](#get-length-of-string)
            * [get uppercase of string](#get-uppercase-of-string)
            * [search for a substring inside a string](#search-for-a-substring-inside-a-string)
            * [change substring in string](#change-substring-in-string)
         - [numeric](#numeric)
            * [addition](#addition)
         ...
         - [list](#list-1)
            ...
            * [qw](#qw)
            * [auto flatten the list](#auto-flatten-the-list)
            * [access elem from the list](#access-elem-from-the-list)
            * [list slice](#list-slice)
         - [array](#array-1)
            * [get number of elements in array](#get-number-of-elements-in-array)
            * [get the highest index in array](#get-the-highest-index-in-array)
            * [modify the element in array](#modify-the-element-in-array)
            * [append an element at the end in array](#append-an-element-at-the-end-in-array)
            * [pop up the last element in array](#pop-up-the-last-element-in-array)
            * [insert the element at begin in array](#insert-the-element-at-begin-in-array)
            * [sort in array](#sort-in-array)
      + [repetitive loop and conditional statement](#repetitive-loop-and-conditional-statement)
         - [repetitive loop](#repetitive-loop)
            * [for](#for)
            * [foreach](#foreach)
            * [declare a local variable in a loop](#declare-a-local-variable-in-a-loop)
            * [while](#while)
            * [do while ](#do-while)
            * [do until](#do-until)
         ...
         - [conditional statement](#conditional-statement)
            ...
            * [unless](#unless)
               ...
               + [unless elsif](#unless-elsif)
            * [given](#given)
      + [mode](#mode)
         - [strict mode](#strict-mode)
         - [warnings mode](#warnings-mode)
      + [re (regular expression)](#re-regular-expression)
      + [references](#references)
         - [anomynous reference](#anomynous-reference)
         - [symbolic references](#symbolic-references)
         - [autovivification](#autovivification)
         - [no automatic dereferencing](#no-automatic-dereferencing)
      + [subroutine](#subroutine)
         - [define a subroutine](#define-a-subroutine)
         - [call a subroutine](#call-a-subroutine)
         - [call a subroutine by passing a value](#call-a-subroutine-by-passing-a-value)
         - [call a subroutine by passing a reference](#call-a-subroutine-by-passing-a-reference)
         - [return a value in subroutine](#return-a-value-in-subroutine)
         - [modify passed value in subroutine](#modify-passed-value-in-subroutine)
         - [access the reference of passed value in subroutine](#access-the-reference-of-passed-value-in-subroutine)
      + [module ](#module)
      ...
      + [file handling](#file-handling)
         ...
         - [copy file](#copy-file)
         - [file test](#file-test)
      + [Perl DBI(Database Independent) module](#perl-dbidatabase-independent-module)
...
<!-- TOC --><a name="syntax"></a>
## syntax
<!-- TOC --><a name="overview-of-data-type"></a>
### overview of data type
<!-- TOC --><a name="basic-data-type"></a>
#### basic data type
...
<!-- TOC --><a name="declaring-variables"></a>
#### declaring variables
> [!NOTE]
...
### function 
<!-- TOC --><a name="define-your-own-function"></a>
...
### comment
<!-- TOC --><a name="single-line-comment"></a>
#### single line comment
...
<!-- TOC --><a name="multi-line-comment"></a>
#### multi-line comment
...
<!-- TOC --><a name="data-type"></a>
### data type
<!-- TOC --><a name="string-1"></a>
#### string
...
<!-- TOC --><a name="concatenation-of-two-strings"></a>
...
<!-- TOC --><a name="repetive-of-a-string"></a>
...
<!-- TOC --><a name="embeding-a-variable-in-string"></a>
...
<!-- TOC --><a name="get-length-of-string"></a>
...
<!-- TOC --><a name="get-uppercase-of-string"></a>
...
<!-- TOC --><a name="search-for-a-substring-inside-a-string"></a>
...
<!-- TOC --><a name="change-substring-in-string"></a>
...
<!-- TOC --><a name="numeric"></a>
#### numeric
<!-- TOC --><a name="addition"></a>
##### addition
See [division](#division)

<!-- TOC --><a name="subtraction"></a>
##### subtraction
See [division](#division)

<!-- TOC --><a name="multiplication"></a>
##### multiplication
See [division](#division)

<!-- TOC --><a name="division"></a>
##### division
...
<!-- TOC --><a name="auto-flatten-the-list"></a>
...
<!-- TOC --><a name="access-elem-from-the-list"></a>
...
<!-- TOC --><a name="array-1"></a>
#### array
<!-- TOC --><a name="get-number-of-elements-in-array"></a>
...
<!-- TOC --><a name="get-the-highest-index-in-array"></a>
...
<!-- TOC --><a name="modify-the-element-in-array"></a>
...
<!-- TOC --><a name="append-an-element-at-the-end-in-array"></a>
...
<!-- TOC --><a name="pop-up-the-last-element-in-array"></a>
...
<!-- TOC --><a name="insert-the-element-at-begin-in-array"></a>
...
<!-- TOC --><a name="repetitive-loop-and-conditional-statement"></a>
### repetitive loop and conditional statement
<!-- TOC --><a name="repetitive-loop"></a>
#### repetitive loop
<!-- TOC --><a name="for"></a>
##### for
...
<!-- TOC --><a name="declare-a-local-variable-in-a-loop"></a>
...
<!-- TOC --><a name="conditional-statement"></a>
...
<!-- TOC --><a name="re-regular-expression"></a>
...
<!-- TOC --><a name="anomynous-reference"></a>
#### anomynous reference
...
<!-- TOC --><a name="symbolic-references"></a>
#### symbolic references
...
<!-- TOC --><a name="no-automatic-dereferencing"></a>
...
<!-- TOC --><a name="subroutine"></a>
### subroutine
<!-- TOC --><a name="define-a-subroutine"></a>
#### define a subroutine
...
<!-- TOC --><a name="call-a-subroutine"></a>
#### call a subroutine
...
<!-- TOC --><a name="call-a-subroutine-by-passing-a-value"></a>
...
<!-- TOC --><a name="call-a-subroutine-by-passing-a-reference"></a>
...
<!-- TOC --><a name="modify-passed-value-in-subroutine"></a>
...
<!-- TOC --><a name="access-the-reference-of-passed-value-in-subroutine"></a>
...
<!-- TOC --><a name="module"></a>
### module 
<!-- TOC --><a name="defining-a-module"></a>
#### defining a module
...
<!-- TOC --><a name="built-in-function"></a>
### built-in function
<!-- TOC --><a name="print"></a>
#### print 
...
<!-- TOC --><a name="perl-dbidatabase-independent-module"></a>
